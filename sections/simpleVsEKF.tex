...
\end{tikzpicture}
\end{flushleft}
\caption{$ \textbf{x}_k $ and $\dot{\textbf{x}}_k $ state estimate comparison}\label{fig:ekfnone}
\end{figure}
...
\end{tikzpicture}
\end{flushleft}
\caption{$ \textbf{x}_k $ and $\dot{\textbf{x}}_k $ state estimate comparison}\label{fig:ekfsig}
\end{figure}
