...
Figure \ref{fig:floorxy} shows that our filters can't estimate small turns accurately, but we can still see the floor shape. The error seems to consistent since when we return to our starting point, its in a distance of less than 1 meter.
