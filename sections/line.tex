...
Now that we have all of our parameters set, we will try to recreate the simulation done in section \ref{subsubsec:ekf} with the $\mu_v$ tuning experiment and see if our EKF improves the x state estimation and if our rotation paramters influences it or not.
