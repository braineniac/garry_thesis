...
When tuning our $\beta$ parameter, we have to be concious also about our $\varrho^{\eta\chi}$, since physical dimension of our input and are the same. This means that the "trust" we place on the input directly effects our $\dot{\Psi}$ state.
...
But since this turn speed is relatively high, we turn in short bursts to turn the robot in the direction we want. The motors need an acceleration period before they reach their tops speed and because of the short input bursts, the turn speed is non-linear, which means that we can't "trust" our $\u^\eta$ and should rely mostly on our gyroscope measurement $y^\chi$ on the IMU.
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Different $\beta$-s influence on the $\Psi$ and $\dot{\Psi}$ state in the beta tuning reference experiment}\label{fig:betas}
\end{figure}
...
This is what we see in Figure \ref{fig:betas} in our 5 turns reference experiment. We set the ratio to $\varrho^{\eta\chi} = 100$, so even bigger changes in beta have almost no impact on the $\Psi$ and $\dot{\Psi}$. In Figure \ref{fig:betaratios} we can observe what happens if the ratio changes. We sticked to $\varrho^{\eta\chi} = 100$ to have better accuracy and $\beta = 7.4$.
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment with no stops using a Kalman Filter}\label{fig:betasingle}
\end{figure}
\end{center}
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment with 10 turns using a Kalman Filter}\label{fig:betamulti}
\end{figure}
\end{center}
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment using the adaptive Kalman Filter}\label{fig:adaptbeta}
\end{figure}
\end{center}
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment with no stops using the adaptive Kalman Filter}\label{fig:adaptbetasingle}
\end{figure}
\end{center}
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment with 10 turns using the adaptive Kalman Filter}\label{fig:adaptbetamulti}
\end{figure}
\end{center}
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment using the Extended Kalman Filter}\label{fig:ekfbeta}
\end{figure}
\end{center}
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment with no stops using the Extended Kalman Filter}\label{fig:ekfbetasingle}
\end{figure}
\end{center}
...
\begin{figure}[H]
 ...
 \begin{flushleft}
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Beta tuning reference experiment with no stops using the Extended Kalman Filter}\label{fig:ekfbetamulti}
\end{figure}
\end{center}

We can observe from the EKF experiments in Figures \ref{fig:ekfbeta}, \ref{fig:ekfbetasingle} and \ref{fig:ekfbetamulti} that there are some differences in the state estimations. We will have to do different tests to determine if the accuracy is actually better than with our adaptive Kalman Filter.
