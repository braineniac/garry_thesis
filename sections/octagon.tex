...
\caption{Octagon experiment setup: 8x 3 meter long tape on the floor with their middles on top of each other in 45\si{\degree} spacing.}
...
A steady balance between model and measurement seems to yield better results with a well set $\varrho_{\eta\chi}$ ratio, same as in Section \ref{sec:floor}.
