...
As we can see from Figure \ref{fig:testmupsi}, our model is not very accurate in describing the rotation of the robot. We are off about about 2 full 360\si{\degree} turns. We will reflect this in the process covariance $\textbf{Q}_k$ and rely more on the gyroscope.
