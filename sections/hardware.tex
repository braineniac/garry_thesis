...
We can see all the parts used to construct the robot in Figure \ref{fig:platform}.
...
\begin{figure}
 ...
 \caption[]{
  An overview of of all components:
  \begin{enumerate}
...
Here is a block diagram of the hardware layout:
\begin{center}
\begin{tikzpicture}[align=center,node distance=2.5cm]
    ...
    \node[block] (cameras) [above of=imu] {Cameras};
    \node[block] (arduino) [below of=imu] {Arduino};
