...
\begin{figure}[H]
\includegraphics[width=12cm, height=7cm]{images/octagon.png}
...
The small drifts between the two filters were also observed in the Subsection \ref{subsec:betatesting}, but in this case it seems that the adaptive Kalman Filter is closer to our initial position.
