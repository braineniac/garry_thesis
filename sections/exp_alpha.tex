...
\begin{flushleft}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt] table {plots/alphas_0_u0.csv};
    \end{axis}
  \end{tikzpicture}
\end{flushleft}
...
\begin{flushleft}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt] table {plots/alphas_0_y0.csv};
    \end{axis}
  \end{tikzpicture}
\end{flushleft}
 ...
 \begin{flushleft}
  \begin{tikzpicture}
   \begin{axis}[
    ...
    \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt] table {plots/alphas_1_x0.csv};
    \addlegendentry{reference}
    \addplot+[color=red, mark=none,line width=1pt,mark size=1pt] table {plots/alphas_single_0_x0.csv};
    \addlegendentry{few stops}
    \addplot+[color=gray, mark=none,line width=1pt,mark size=1pt, samples=2, dashed] {5.0};
   \end{axis}
  \end{tikzpicture}
 \end{flushleft}
 \caption{Repeated reference experiment with less stops}\label{fig:fewstops}
\end{figure}
 ...
 \begin{flushleft}
  \begin{tikzpicture}
   \begin{axis}[
    ...
    \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt] table {plots/alphas_1_x0.csv};
    \addlegendentry{reference}
    \addplot+[color=red, mark=none,line width=1pt,mark size=1pt] table {plots/alphas_multi_0_x0.csv};
  ...
  \end{tikzpicture}
 \end{flushleft}
 \caption{Reference experiment with 10m distance}\label{fig:exp_10m}
\end{figure}
