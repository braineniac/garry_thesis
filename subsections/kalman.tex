...
\begin{flushleft}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt] table {plots/sim_line_u0.csv};
    \end{axis}
  \end{tikzpicture}
\end{flushleft}
...
\begin{flushleft}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt] table {plots/sim_line_y0.csv};
    \end{axis}
  \end{tikzpicture}
\end{flushleft}
...
\begin{flushleft}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot+[color=red, mark=none,line width=1pt,mark size=1pt] table {plots/sim_line_adaptive_Q0.csv};
    \end{axis}
  \end{tikzpicture}
\end{flushleft}
 ...
 \begin{flushleft}
  \begin{tikzpicture}
   \begin{axis}[
    ...
    \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt, dashed] table {plots/sim_line_x0.csv};
    \addlegendentry{disabled}
    \addplot+[color=red, mark=none,line width=1pt,mark size=1pt] table {plots/sim_line_adaptive_x0.csv};
 ...
 \begin{flushleft}
  \begin{tikzpicture}
   \begin{axis}[
    ...
    \addplot+[color=blue, mark=none,line width=1pt,mark size=1pt, dashed] table {plots/sim_line_x2.csv};
    \addlegendentry{disabled}
    \addplot+[color=red, mark=none,line width=1pt,mark size=1pt] table {plots/sim_line_adaptive_x2.csv};
    \addlegendentry{enabled}
   \end{axis}
  \end{tikzpicture}
 \end{flushleft}
