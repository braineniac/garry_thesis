 ...
 \begin{flushleft}
  \begin{tikzpicture}
   \begin{axis}[
    ...
    \addplot+[smooth,color=blue, mark=none,line width=1pt,mark size=1pt] table {plots/sim_robot_dist_.csv};
    \addlegendentry{none}
  ...
  \begin{tikzpicture}
   \begin{axis}[
    ...
    \addplot+[color=red, mark=none,line width=1pt,mark size=1pt] table {plots/sim_robot_vel_.csv};
    \addlegendentry{none}
