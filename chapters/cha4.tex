...
\begin{figure}[H]
 ...
 \begin{subfigure}[b]{0.5\textwidth}
  ...
  \caption{Falling edge}
 \end{subfigure}
 \caption{Comparison of the desired simulated v state and estimated v state by the Kalman filter and Kalman filter with adaptive process noise during rising and falling edge}\label{fig:kalmansim}
\end{figure}
