...
\begin{titlepage}
    ...
    \newlength{\Top}
    \setlength{\Top}{3cm} % Höhe der Mittellinie durch die Logos und den Schriftzug Diplomarbeit
...
\end{titlepage}
	...
	\begin{hyphenrules}{ngerman}
		...
		{
			\ClassError{ACIN_diploma_thesis}{File pre1_Preface does not exist!}
	...
	\begin{hyphenrules}{USenglish}
		...
		{
			\ClassError{ACIN_diploma_thesis}{File pre2_Abstract does not exist!}
	...
	\begin{hyphenrules}{ngerman}
		\InputIfFileExists{pre3_Kurzzusammenfassung}{}
		{
			...
			\ClassError{ACIN_diploma_thesis}{File pre3_Kurzzusammenfassung does not exist!}
...
% 	\thispagestyle{empty}
% 
% 	\noindent Hiermit versichere ich, dass ich die vorliegende Arbeit
% selbstständig verfasst und keine anderen als die angegebenen Quellen und Hilfsmittel benutzt habe.\vspace{3cm}
% 
% 	\noindent%
% 	\PlaceAndTime
% 
